                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a href="{{route('product.index')}}">Product</a>
                                    </li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="title" class="form-control" data-validation-required-message="Required" placeholder="Title">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
