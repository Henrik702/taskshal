...
@section('content')
        <section class="ontainer small-container">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade @if(Route::current()->getName() == 'login') show active @endif" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
